...
public class MenuSetting {
    ...
    public static void add() throws JSONException {
        String s = getAccessToken();
        NetWorkHelper netHelper = new NetWorkHelper();
        String json = "{\"button\":[{\"name\":\"趣味答题\",\"sub_button\":[{\"type\":\"view\",\"name\":\"开始答题\",\"url\":\"http://z3ryuc.natappfree.cc/weather/qa.html\"}]},{\"name\":\"我的排名\",\"sub_button\":[{\"type\":\"view\",\"name\":\"个人排名\",\"url\":\"http://www.hnust.cn\"},{\"type\":\"view\",\"name\":\"班级排名\",\"url\":\"http://www.hnust.cn\"},{\"type\":\"view\",\"name\":\"设置\",\"url\":\"http://www.hnust.cn\"}]},{\"name\":\"个人中心\",\"sub_button\":[{\"type\":\"view\",\"name\":\"关于我\",\"url\":\"http://www.hnust.cn/\"},{\"type\":\"view\",\"name\":\"联系我\",\"url\":\"http://www.hnust.cn/\"}]}]}";
